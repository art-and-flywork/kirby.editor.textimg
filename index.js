...
},{}],"components/TextImg.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: (_methods = {
    onEnter: function onEnter(html) {
      var newthis = this.$refs.text;
      newthis.dispatch(newthis.tr().replaceSelectionWith(newthis.schema().nodes.hard_break.create()).scrollIntoView());
    },
    storeTitle: function storeTitle(html) {
      console.log(html);
      this.$emit("input", {
        title: html
      });
    },
    storeText: function storeText(html) {
      this.$emit("input", {
        content: html
      });
    },
    ...
    input: function input(data) {
      this.$emit("input", {
        attrs: _objectSpread(_objectSpread({}, this.attrs), data)
      });
    }
  }, (0, _defineProperty2.default)(_methods, "storeText", function storeText(data) {
    this.$emit("input", {
      text: _objectSpread(_objectSpread({}, this.text), data)
    });
  }), (0, _defineProperty2.default)(_methods, "fetchFile", function fetchFile(link) {
    var _this = this;
  ...
  }), (0, _defineProperty2.default)(_methods, "insertFile", function insertFile(files) {
    var file = files[0];
    this.fetchFile(file.link);
  }), (0, _defineProperty2.default)(_methods, "insertUpload", function insertUpload(files, response) {
    this.fetchFile(response[0].link);
    this.$events.$emit("file.create");
    this.$events.$emit("model.update");
    this.$store.dispatch("notification/success", ":)");
  }), (0, _defineProperty2.default)(_methods, "menu", function menu() {
    if (this.attrs.src) {
      return [{
        icon: "open",
  ...
  }), (0, _defineProperty2.default)(_methods, "onDrop", function onDrop(files) {
  ...
  }), (0, _defineProperty2.default)(_methods, "replace", function replace() {
    this.$emit("input", {
      attrs: {}
    });
  }), (0, _defineProperty2.default)(_methods, "selectFile", function selectFile() {
    this.$refs.fileDialog.open({
      endpoint: this.endpoints.field + "/files",
      multiple: false,
      selected: [this.attrs.id]
    });
  }), (0, _defineProperty2.default)(_methods, "settings", function settings() {
    this.$refs.settings.open();
  }), (0, _defineProperty2.default)(_methods, "saveSettings", function saveSettings() {
    this.$refs.settings.close();
    this.input(this.attrs);
  }), (0, _defineProperty2.default)(_methods, "uploadFile", function uploadFile() {
...
exports.default = _default;
        var $0a166a = exports.default || module.exports;
      
      if (typeof $0a166a === 'function') {
        $0a166a = $0a166a.options;
      }
    
        /* template */
        Object.assign($0a166a, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "div",
    { staticClass: "textimg__split" },
    [
      _c(
        "div",
        { staticClass: "textimg__text" },
        [
          _c(
            "h2",
            [
              _c("k-editable", {
                ...
                attrs: {
                  ...
                  content: _vm.text.title
                },
                on: { input: _vm.storeTitle }
              })
            ],
            1
          ),
          ...
          _c("k-editable", {
            ...
            on: { input: _vm.storeText, enter: _vm.onEnter, split: _vm.onEnter }
          })
        ],
        1
      ),
          ...
          _vm.attrs.src
            ? [
                _c(
                  ...
                  {
                    ref: "element",
                    staticClass: "k-editor-textimg-block-wrapper",
                    style: _vm.style,
                    attrs: {
            ...
            : [
                _c(
                  ...
                  {
                    ref: "element",
                    staticClass: "k-editor-textimg-block-placeholder",
                    attrs: { tabindex: "0" },
                    on: { drop: _vm.onDrop },
                    nativeOn: {
                      keydown: [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$0a166a', $0a166a);
          } else {
            api.reload('$0a166a', $0a166a);
          }
        }
...
},{"@babel/runtime/helpers/defineProperty":"../node_modules/@babel/runtime/helpers/defineProperty.js","_css_loader":"../node_modules/parcel/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _TextImg = _interopRequireDefault(require("./components/TextImg.vue"));
 ...
 */
editor.block("Textimg", _TextImg.default);
},{"./components/TextImg.vue":"components/TextImg.vue"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
